...
%* Agent: agent name / identifier 
%* Query: query to Environment or its clone where Agent is situated
...
%* Agent: agent name / identifier 
%* Query: query to Environment or its clone where Agent is situated
%* Answers: answers to Query from Environment / Clone where the Agent is
...
% findall_environment(Environment, Agent, Query, Answers):-
%    findall(Query, fact(Environment, _, Query),
%            Answers).
...
%* Environment: environment name
%* Agent: agent name / identifier 
%* Facts: list of atoms or formulas
...
%!  add_facts_clone(+Environment, +Clone, +Facts) is det
%Asserts facts for Environment's Clone. If Clone is the same as Environment, 
%then it is the main / original Environment instance
%* Environment: environment name
%* Clone: clone name 
%* Facts: list of atoms or formulas
...
add_facts_clone(Environment, Clone, [Fact| Facts]):-
    add_fact(fact(Environment, Clone, Fact)),
    add_facts_clone(Environment, Clone, Facts).
...
%Add Beliefs to the Environment or its clone where Agent is
%and also process add/delete lists for all the agents in the Environent/clone
...
%* Agent: agent name / identifier 
%* Belief: list of atoms or formulas
...
%Deletes Beliefs to add lists of the Agents 
%environment (or clone of the environment)
%* Agents: list of agents' names / identifiers 
%* Beliefs: list of atoms or formulas
