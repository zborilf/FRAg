...
frag_choice(54):-
    ...
    writeln("Reasonings:"),
    write("-> Intention selection: "),write(INTENTIONSELECTION),nl,
    write("-> Plan selection: "),write(PLANSELECTION),nl,
    write("-> Substitution selection: "),write(SUBSTITUTIONSELECTION),nl,
